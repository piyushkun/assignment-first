  ...
  return (
    <div>
      <article class="recipe">
        ...
        <p>
          “Vindaloo” is a popular Indian <a className= "pink" href="none">curry dish</a> that
          calls for meat to be marinated in a highly flavorful spicy mixture
        ...
        <aside>
          <p>
            ...
            <a className = "black" href="underline">Click here</a> for an alternative recipe with less
            heat.
          </p>
        </aside>
      </article>
